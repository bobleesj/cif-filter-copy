...
def test_copy_files_based_on_atomic_occupancy_mixing():
    ...
    directory_list = [deficiency_atomic_mixing_dir,
    ...
    assert get_cif_file_count_from_directory(base_dir) == 8, "Expected 8 files in the test folder"
    
    deficiency_atomic_mixing_dir_cif_count = get_cif_file_count_from_directory(deficiency_atomic_mixing_dir)
    full_occupancy_atomic_mixing_dir_cif_count = get_cif_file_count_from_directory(full_occupancy_atomic_mixing_dir)
    deficiency_no_atomic_mixing_dir_cif_count = get_cif_file_count_from_directory(deficiency_no_atomic_mixing_dir)
